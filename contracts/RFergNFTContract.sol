...
error RFergNFTContract__MaxSupplyReached();
error RFergNFTContract__ValueNotEqualPrice();
error RFergNFTContract__WrongAvenueForThisTransaction();

/// @custom:security-contact rferg.nft@gmail.com
contract RFergNFTContract is ERC721,
    ERC721Enumerable,
    ERC721URIStorage,
    ERC721Burnable,
    ERC721Royalty,
    ...
    ReentrancyGuard
{
    ...
    receive() external payable {
        revert RFergNFTContract__WrongAvenueForThisTransaction();
    }
